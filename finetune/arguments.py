...
class ModelArguments:
    ...
    bidirectional: bool = field(
        default=False,
        metadata={"help": "If passed, the model will use bidirectional attention."}
    )
    lm_head_path: str = field(
        default=None,
        metadata={"help": "The path to the new lm head."}
    )

@dataclass
class DataArguments:
    train_data: str = field(
        default='cfli/bge-full-data',
...
class RetrieverTrainingArguments(TrainingArguments):
    ...
    pooling_method: str = field(default='max-pooling', metadata={"help": "the pooling method to extract embeddings"})
